...
parser.add_argument('--deg_pos_genes_count', type=int, help='number of degs to use')
...
rank_pr_genes_func.rank_pr_genes(ranks_output, args.pr_genes_path, args.deg_output_path, args.np_output_path, args.nx_network_path, args.deg_pos_genes_count, args.np_pos_genes_count, args.agg_method)


# Rank Evaluation
rank_eval_func.rank_evaluation(ranks_output, np_pos_genes_count, args.n_auc_min, args.n_auc_max, args.pr_genes_path, args.nx_network_path, args.agg_method)